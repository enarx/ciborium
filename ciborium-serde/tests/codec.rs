...
use ciborium_serde::value::Value;
use ciborium_serde::{cbor, de::from_reader, ser::into_writer};
...
#[rstest(value, bytes, alternate,
    ...
    case(cbor!(f64::INFINITY).unwrap(), "f97c00", false),
    case(cbor!(f64::NAN).unwrap(), "f97e00", false),
    case(cbor!(-f64::INFINITY).unwrap(), "f9fc00", false),
    case(cbor!(f64::INFINITY).unwrap(), "fa7f800000", true),
    case(cbor!(f64::NAN).unwrap(), "fa7fc00000", true),
    case(cbor!(-f64::INFINITY).unwrap(), "faff800000", true),
    case(cbor!(f64::INFINITY).unwrap(), "fb7ff0000000000000", true), // 40
    case(cbor!(f64::NAN).unwrap(), "fb7ff8000000000000", true),
    case(cbor!(-f64::INFINITY).unwrap(), "fbfff0000000000000", true),

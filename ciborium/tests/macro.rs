...
#[rstest(answer, question,
    ...
    case(arr![Value::Null], cbor!([null]).unwrap()),
    ...
    case(arr![Value::Null, Value::Null], cbor!([null, null]).unwrap()),
    case(arr![Value::Null, true], cbor!([null, true]).unwrap()),
    case(arr![Value::Null, false], cbor!([null, false]).unwrap()),
    case(arr![Value::Null, "foo"], cbor!([null, "foo"]).unwrap()),
    case(arr![Value::Null, 123], cbor!([null, 123]).unwrap()),
    case(arr![Value::Null, -123], cbor!([null, -123]).unwrap()),
    case(arr![Value::Null, 1.23], cbor!([null, 1.23]).unwrap()),
    case(arr![Value::Null, -1.23], cbor!([null, -1.23]).unwrap()),
    case(arr![Value::Null, 2.5e+1], cbor!([null, 2.5e+1]).unwrap()),
    case(arr![Value::Null, 2.5e+1], cbor!([null, 2.5e+1]).unwrap()),
    case(arr![Value::Null, [1, 2]], cbor!([null, [1, 2]]).unwrap()),
    case(arr![Value::Null, map! {1=>2,3=>4}], cbor!([null, {1=>2,3=>4}]).unwrap()),
    case(arr![true, Value::Null], cbor!([true, null]).unwrap()),
    ...
    case(arr![false, Value::Null], cbor!([false, null]).unwrap()),
    ...
    case(arr!["foo", Value::Null], cbor!(["foo", null]).unwrap()),
    ...
    case(arr![123, Value::Null], cbor!([123, null]).unwrap()),
    ...
    case(arr![-123, [1, 2]], cbor!([-123, [1, 2]]).unwrap()),
    case(arr![-123, map! {1=>2,3=>4}], cbor!([-123, {1=>2,3=>4}]).unwrap()),
    case(arr![1.23, Value::Null], cbor!([1.23, null]).unwrap()),
    ...
    case(arr![-1.23, [1, 2]], cbor!([-1.23, [1, 2]]).unwrap()),
    case(arr![-1.23, map! {1=>2,3=>4}], cbor!([-1.23, {1=>2,3=>4}]).unwrap()),
    case(arr![2.5e+1, Value::Null], cbor!([2.5e+1, null]).unwrap()),
    ...
    case(arr![2.5e+1, [1, 2]], cbor!([2.5e+1, [1, 2]]).unwrap()),
    case(arr![2.5e+1, map! {1=>2,3=>4}], cbor!([2.5e+1, {1=>2,3=>4}]).unwrap()),
    case(arr![[1, 2], Value::Null], cbor!([[1, 2], null]).unwrap()),
    ...
    case(arr![map! {1=>2,3=>4}, Value::Null], cbor!([{1=>2,3=>4}, null]).unwrap()),
    ...
    case(map! {Value::Null => Value::Null}, cbor!({ null => null }).unwrap()),
    case(map! {Value::Null => true}, cbor!({ null => true }).unwrap()),
    case(map! {Value::Null => false}, cbor!({ null => false }).unwrap()),
    case(map! {Value::Null => "foo"}, cbor!({ null => "foo" }).unwrap()),
    case(map! {Value::Null => 123}, cbor!({ null => 123 }).unwrap()),
    case(map! {Value::Null => -123}, cbor!({ null => -123 }).unwrap()),
    case(map! {Value::Null => 1.23}, cbor!({ null => 1.23 }).unwrap()),
    case(map! {Value::Null => -1.23}, cbor!({ null => -1.23 }).unwrap()),
    case(map! {Value::Null => 2.5e+1}, cbor!({ null => 2.5e+1 }).unwrap()),
    case(map! {Value::Null => 2.5e+1}, cbor!({ null => 2.5e+1 }).unwrap()),
    case(map! {Value::Null => [1, 2]}, cbor!({ null => [1, 2] }).unwrap()),
    case(map! {Value::Null => map! {1=>2,3=>4}}, cbor!({ null => {1=>2,3=>4} }).unwrap()),
    case(map! {true => Value::Null}, cbor!({ true => null }).unwrap()),
    ...
    case(map! {false => Value::Null}, cbor!({ false => null }).unwrap()),
    ...
    case(map! {"foo" => Value::Null}, cbor!({ "foo" => null }).unwrap()),
    ...
    case(map! {123 => Value::Null}, cbor!({ 123 => null }).unwrap()),
    ...
    case(map! {-123 => [1, 2]}, cbor!({ -123 => [1, 2] }).unwrap()),
    case(map! {-123 => map! {1=>2,3=>4}}, cbor!({ -123 => {1=>2,3=>4} }).unwrap()),
    case(map! {1.23 => Value::Null}, cbor!({ 1.23 => null }).unwrap()),
    ...
    case(map! {-1.23 => [1, 2]}, cbor!({ -1.23 => [1, 2] }).unwrap()),
    case(map! {-1.23 => map! {1=>2,3=>4}}, cbor!({ -1.23 => {1=>2,3=>4} }).unwrap()),
    case(map! {2.5e+1 => Value::Null}, cbor!({ 2.5e+1 => null }).unwrap()),
    ...
    case(map! {2.5e+1 => [1, 2]}, cbor!({ 2.5e+1 => [1, 2] }).unwrap()),
    case(map! {2.5e+1 => map! {1=>2,3=>4}}, cbor!({ 2.5e+1 => {1=>2,3=>4} }).unwrap()),
    case(map! {[1, 2] => Value::Null}, cbor!({ [1, 2] => null }).unwrap()),
    ...
    case(map! {map! {1=>2,3=>4} => Value::Null}, cbor!({ {1=>2,3=>4} => null }).unwrap()),

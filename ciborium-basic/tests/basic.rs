...
#[rstest(title, bytes,
    ...
    case(Title::from(f64::INFINITY), "f97c00"),
    case(Title::from(f64::NAN), "f97e00"),
    case(Title::from(-f64::INFINITY), "f9fc00"),
    case(float![Subsequent4(f32::INFINITY)], "fa7f800000"),
    case(float![Subsequent4(f32::NAN)], "fa7fc00000"),
    case(float![Subsequent4(-f32::INFINITY)], "faff800000"),
    case(float![Subsequent8(f64::INFINITY)], "fb7ff0000000000000"),
    case(float![Subsequent8(f64::NAN)], "fb7ff8000000000000"),
    case(float![Subsequent8(-f64::INFINITY)], "fbfff0000000000000"),
